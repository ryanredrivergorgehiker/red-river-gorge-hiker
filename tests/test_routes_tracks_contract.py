...
class RoutesTracksContractTests(unittest.TestCase):
    ...
    def test_map_visual_legend_matches_cartography(self):
        ...
        self.assertIn(".swatch-usfs-trail::before{height:0;border-top:3px dashed #00c8ff}", ROUTES_CSS)
        self.assertIn(".swatch-usfs-road::before{height:0;border-top:3px dashed #ffcf33}", ROUTES_CSS)
