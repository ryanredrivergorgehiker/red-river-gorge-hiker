...
class LlcWebsiteTransitionStagingContract(unittest.TestCase):
    ...
    def test_copyright_and_terms_exact_llc_language(self):
        ...
        required = [
            ...
            "Photographs displayed on RedRiverGorgeHiker.com that are identified as photography by Ryan D. Lewis are copyrighted and owned by Ryan D. Lewis unless expressly stated otherwise. The formation and operation of Red River Gorge Hiker, LLC do not transfer ownership of those photograph copyrights to the LLC.",
    ...
    def test_privacy_production_ready_copy_and_date(self):
        ...
        self.assertIn("Last updated: September 25, 2026", text)
