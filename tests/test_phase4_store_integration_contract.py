...
class Phase4StoreIntegrationContract(unittest.TestCase):
    ...
    def test_privacy_and_terms_store_disclosures(self):
        self.assertIn('Last updated: September 23, 2026', PRIVACY)
    ...
    def test_primary_navigation_shop_change_and_photo_copyright_remain_intact(self):
        ...
        self.assertIn('View Photography', HEADER)
        ...
        self.assertIn('Photograph {photo.copyrightNotice}', PHOTO_DETAIL)
        self.assertNotIn('Photograph © Ryan D. Lewis. All rights reserved.', PHOTO_DETAIL)
