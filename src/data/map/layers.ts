...
export const mapSources: readonly MapSource[] = [
  ...
  },
  {
    ...
    label: 'Sunrise / Sunset pilot — crest-connected',
    kind: 'derived',
    enabled: true,
    browserLoaded: true,
    serviceUrl: 'https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer',
    attribution: 'Red River Gorge Hiker crest-connected Pinch-Em-Tight calibration derived from USGS 3DEP elevation, USDA NAIP imagery, and © OpenStreetMap contributors trail/water features',
    termsUrl: 'https://www.openstreetmap.org/copyright',
