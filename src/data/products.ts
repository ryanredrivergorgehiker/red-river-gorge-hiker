...
export const photographs: readonly Photograph[] = [
  {
    ...
    shortDescription: 'A brilliant double rainbow breaks over the Red River Gorge from Eagle’s Point Buttress after a heavy summer storm, spanning the landscape as the storm clears.',
  ...
  },
  {
    ...
    shortDescription: 'A vivid winter sunrise illuminates the horizon beside the sandstone hueco known as Eagle’s Nest, photographed from a campsite that provided a better view of the morning sky.',
  ...
  },
  {
    ...
    shortDescription: 'A remote four-drop cascade descends through layered sandstone before splattering into an amber pool. Ryan documented and named the waterfall during an off-trail exploration.',
