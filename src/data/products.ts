...
export const photographs: readonly Photograph[] = [
  {
    ...
    story: 'On July 19, 2025, Ryan camped near Eagle’s Point Buttress while testing gear for a Sheltowee Trace thru-hike he was already preparing to undertake. The evening was extremely hot and rainy. After a heavy rain, he kept a campfire going and watched a group of hikers descend the mountain as the weather cleared quickly. He called home to say goodnight to his daughter Lilianna and was speaking with his partner Charlee as he walked onto the lower overlook. A brilliant double rainbow appeared over the clearing landscape, and Charlee urged him to get off the phone and photograph it. The resulting panorama became his signature image. Ryan experienced the rainbow not as a call to begin the Sheltowee Trace, but as a deeply personal assurance that he would be able to complete the journey he had already chosen and was preparing for. He later completed the thru-hike.',
  ...
  },
  {
    ...
    story: 'On January 23, 2024, Ryan and his cousin chose a spontaneous snowy day hike after Ryan’s unsuccessful backpacking attempt along Swift Camp Creek. Both had visited Red-byrd Arch before and approached from the Calaboose Ridge Road side using prior knowledge, maps, and a very faint trace rather than a formal trail. The ice and snow were unusually severe, and they used a short rappel to descend an icy section. Ryan remembers it as a fun winter outing and rappel with his cousin.',
  ...
  },
  {
    ...
    story: 'On December 20, 2025, Ryan led three friends on a hike to Copperas Falls. After they departed, he continued to Eagle’s Nest and camped overnight. Ryan already knew the hueco known as Eagle’s Nest, but once he arrived he chose a different campsite than usual, a decision made in the moment that offered a better sunrise vantage than his customary site. The next morning, December 21, 2025, he traversed west from Eagle’s Point Buttress Overlook along the ridge top and cliff edge and photographed an exceptionally vibrant sunrise from that improved position. The morning was chilly, clear, and pleasant. Ryan was alone for the sunrise, and it remains the most vivid sunrise he has personally seen.',
